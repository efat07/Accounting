...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		.cors().and()
		.csrf().disable()
		.authorizeRequests().antMatchers(HttpMethod.GET, "/getInfoBills").permitAll()
		.antMatchers(HttpMethod.GET, "/getInfoInvoices").permitAll()
		.antMatchers(HttpMethod.GET, "/getInfoReceipts").permitAll()
